...
class Marketer(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = ['user_name', 'first_name', 'gender', 'percentage', 'Minimum_receive_money', 'reference_code']
...
class Promotion(models.Model):
    ref_course = models.CharField(max_length=100)
    ref_user = models.CharField(max_length=100)
